    ...
    <div className="mb-4">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
        <div className="bg-white border border-gray-200 rounded-2xl shadow-sm p-4">
          <h4 className="text-xs font-semibold text-gray-500 uppercase tracking-wide mb-2">All Trades</h4>
        ...
        <div className="bg-white border border-gray-200 rounded-2xl shadow-sm p-4">
          <h4 className="text-xs font-semibold text-green-600 uppercase tracking-wide mb-2">Profit Trades</h4>
        ...
        <div className="bg-white border border-gray-200 rounded-2xl shadow-sm p-4">
          <h4 className="text-xs font-semibold text-red-500 uppercase tracking-wide mb-2">Losing Trades</h4>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="bg-white border border-gray-200 rounded-2xl shadow-sm p-4">
          <h4 className="text-xs font-semibold text-gray-500 uppercase tracking-wide mb-2">Winning vs Losing Trades</h4>
          <div className="h-48 flex items-center">
            ...
            <div className="text-xs space-y-1">
              <div className="text-green-600 font-medium">Winning: {winPct.toFixed(2)}%</div>
              <div className="text-red-500 font-medium">Losing: {(100 - winPct).toFixed(2)}%</div>
            </div>
          </div>
        </div>
        <div className="bg-white border border-gray-200 rounded-2xl shadow-sm p-4">
          <h4 className="text-xs font-semibold text-gray-500 uppercase tracking-wide mb-2">P&L History</h4>
          <div className="h-48">
